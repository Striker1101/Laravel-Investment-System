            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-lg-offset-3 col-md-offset-3 col-xs-12">
                    ...
                    <form method="post" accept-charset="utf-8" class="block" enctype="multipart/form-data"
                        ...
                        <div class="input-group">
                            <input required type="text" name="reference" autocomplete="reference"
                                class="form-control" placeholder="Enter Reference ID (Required)*"
                                aria-describedby="basic-addon4" value="{{ request()->query('reference') }}">
