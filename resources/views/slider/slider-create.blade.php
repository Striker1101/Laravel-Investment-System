                ...
                <div class="panel-body">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input name="title" value="" class="form-control input-lg" type="text" required
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input name="description" value="" class="form-control input-lg" type="text"
                                    required placeholder="Slider Description">
                            </div>
                        </div>
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail" style="width: 175px; height: 75px;"
                                        ...
                                        <img style="width: 175px"
                                            src="https://placeholdit.imgix.net/~text?txtsize=15&txt=(170x75)%20PNG%20image%20&w=170&h=75"
                                            alt="...">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-offset-3 col-md-6">
                                    <button type="submit" class="btn btn-blue btn-block margin-top-10"><i
                                            class="entypo-direction"></i> Create New Slider</button>
                                </div>
                            </div>
                        </div>
                    </div>
