                                ...
                                <table class="table table-striped table-hover table-bordered " id="table-4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="background-color: #000;color: white;">{{ $Percentage_Growth or '' }}
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="background-color: #000;color: white;">Amount available for payout
                                            </td>
                                            <td style="background-color: #000;color: white;">{{ $Available_Payout or '' }}
                                            </td>
                                        </tr>
