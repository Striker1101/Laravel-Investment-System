...
class WithdrawController extends Controller
{
    ...
    public function submitWithdraw(Request $request)
    {
        ...
        if ($amount < $method->method_min) {
            ...
            $wid['withdraw_address'] = $request->withdraw_address;
            $wid['network_name'] = $request->network_name;
            $wid['email'] = $request->email;
    ...
    public function withdrawHistory()
    {
        ...
        $data['withdraw'] = Withdraw::whereUser_id(Auth::user()->id)
            ->orderBy('id', 'DESC')
            ->get();
