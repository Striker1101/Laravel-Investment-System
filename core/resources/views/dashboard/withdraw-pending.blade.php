            ...
            <tbody>
                ...
                @foreach ($withdraw as $p)
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-info btn-icon icon-left delete_button" data-toggle="modal"
                                data-target="#DelModal" data-id="{{ $p->id }}">
                                <i class="fa fa-send"></i> Payment
                            </button>
                            <button type="button" class="btn btn-danger btn-icon icon-left ref_button" data-toggle="modal"
                                data-target="#refModal" data-id="{{ $p->id }}">
                                <i class="fa fa-exclamation-triangle"></i> Refund
                            </button>
                        </td>
                        <td>
                            <button data-toggle="modal" data-target="#view-modal" data-id="{{ $p->id }}"
