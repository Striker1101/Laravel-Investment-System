            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2 col-sm-12">
                    <button type="button" class="btn btn-danger  btn-lg btn-icon btn-block icon-left delete_button"
                        data-toggle="modal" data-target="#DelModal" data-id="{{ $fund->id }}">
                ...
                <div class="modal-footer">
                    ...
                    <form method="post" action="{{ route('manual-payment-confirm') }}" id="form2" class="form-inline">
                        ...
                        <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i>
                            Close</button>
                        <button type="submit" id="btnSubmit" name="btnSubmit" onclick="submitForms()"
                            class="btn btn-danger"><i class="fa fa-check"></i> Yes I'm Sure..!</button>
                    </form>
                </div>
