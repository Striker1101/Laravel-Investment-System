                    ...
                    <form action="{{ route('login') }}" method="post" accept-charset="utf-8" class="block">
                        ...
                        <div class="input-group">
                            <input type="email" name="email" value="{{ old('email') }}" required class="form-control"
                                placeholder="Enter Email Address" aria-describedby="basic-addon3">
                        ...
                        <div class="input-group">
                            <input type="password" name="password" autocomplete="new-password" required class="form-control"
                                placeholder="Enter Password" aria-describedby="basic-addon4">
                        ...
                        <div class="login_option clear_fix">
                            <div class="submit_button flt_left">
                                <button type="submit" class="transition3s hvr-sweep-to-rightB"><i class="fa fa-send"></i>
                                    Login</button>
                                <div class="input-group">
