...
<head>
    ...
    <link href='https://fonts.googleapis.com/css?family=Alegreya:400,400italic,700,900,700italic,900italic'
        rel='stylesheet' type='text/css'>
    <!-- Font Awesome -->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 top_header_right pull-right">
                        ...
                        @if (Auth::check())
                            <div class="dropdown">
                                <button style="padding: 5px 10px;font-size: 17px;font-weight: 600;"
                                    class="btn-dropdown dropdown-toggle" type="button" id="dropdownMenu1"
                                    data-toggle="dropdown" aria-haspopup="true">
                                    <i class="fa fa-user"></i> Hi. {{ \Illuminate\Support\Facades\Auth::user()->name }}
                                    <i class="fa fa-angle-down"></i>
                                </button>
                                <ul style="min-width: 165px;text-align:left;top: 30px;left: -5px;border-radius: 0px 0px 3px 3px"
                                    class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                    <li><a style="color:#fff" href="{{ route('user-dashboard') }}"><i
                                                class="fa fa-dashboard"></i> Dashboard</a></li>
                                    <li>
                                        <a style="color: #fff" href="{{ route('logout') }}"
                                            onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"
                                            class=""><i class="fa fa-sign-out right"></i>Log Out</a>
                        ...
                        @else
                            <a style="margin-bottom: 5px;font-size: 17px;font-weight: 600;" href="{{ route('login') }}"
                                class=""><i class="fa fa-sign-in"></i> Log In</a>
                            &nbsp;&nbsp;&nbsp;<a style="margin-bottom: 5px;font-size: 17px;font-weight: 600;"
                                href="{{ route('register') }}" class=""><i class="fa fa-user-plus"></i>
                                Registration</a>
                        @endif
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-9 col-sm-12 col-xs-12 pull-right address_container">
                        ...
                        <div>
                            ...
                            <div class="text_holder">
                                <p>Address
                                    <span>{{ substr($general->address, 0, 18) }}{{ strlen($general->address) > 20 ? '..' : '' }}</span>
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="collapse navbar-collapse" id="navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                ...
                                @foreach ($menu as $m)
                                    <li>
                                        <a
                                            href="{{ url('menu/') }}/{{ $m->id }}/{{ urlencode(strtolower($m->name)) }}">
                                            {{ $m->name }}
                                        </a>
                                    </li>
                                @endforeach
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 contact_us">
                            ...
                            <ul>
                                ...
                                <li><span>Mail Us</span><a href="mailto:{{ $general->email }}"
                                        class="transition3s">{{ $general->email }}</a></li>
                                <li><span>Any Enquiries</span><a href="tel:{{ $general->number }}"
                                        class="transition3s">{{ $general->number }}</a></li>
                            </ul>
                        </div>
                    </div>
                </div> <!-- End main footer -->
